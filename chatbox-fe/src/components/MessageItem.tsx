    ...
    <div className={`message-item ${isOwn ? 'own' : ''}`}>
      ...
      <div className="message-content">
        ...
        {message.type === MsgTypeEnum.Image && message.fileUrl && (
          <a href={message.fileUrl} target="_blank" rel="noopener noreferrer" className="message-image-link">
        ...
        {message.type === MsgTypeEnum.File && message.fileUrl && (
          <div className="message-file-box">
            <a href={message.fileUrl} download className="message-file-link">
              ...
              <span className="message-file-name">{message.fileUrl.split('/').pop()}</span>
            </a>
            <a href={message.fileUrl} download className="message-file-download" title="Download">
